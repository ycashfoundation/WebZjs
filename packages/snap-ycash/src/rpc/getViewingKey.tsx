      ...
      params: {
        ...
        content: (
          <Box>
            ...
            <Text>Viewing Key is used to create a new account in the Ycash Web Wallet. Web wallet account is serialized and stored only locally. Viewing Key is not sent, logged, or stored in any way.</Text>
            <Divider />
